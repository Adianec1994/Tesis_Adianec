      ...
      <v-dialog v-model="dialog" max-width="450px">
        <template v-slot:activator="{ on }">
          <v-btn
            ...
            v-if="allowed('dato_general','create')"
          >Nuevo</v-btn>
        </template>
        <v-card>
          <v-card-title>
    ...
    >
      <template v-slot:items="props">
        ...
        <td class="text-xs-center justify-center">
          <v-tooltip bottom v-if="allowed('dato_general','update')">
            <v-icon
              small
          ...
          <v-tooltip bottom v-if="allowed('dato_general','delete')">
            <v-icon
              small
              color="red lighten-2"
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: 'Generación bruta (kWh)', value: 'genBruta', align: 'center' },
      { text: 'Insumos (kWh)', value: 'insumos', align: 'center' },
      { text: 'Recibido (lts)', value: 'recibido', align: 'center' },
      { text: 'Volumen recibido (lts)', value: 'volumenRecibido', align: 'center' },
      { text: 'Consumo generación (lts)', value: 'consumoGeneracion', align: 'center' },
      { text: 'Densidad ponderada (g/lts)', value: 'densidadPonderada', align: 'center' },
      { text: 'Temperatura (ºC)', value: 'temperatura', align: 'center' },
      { text: 'Densidad corrección (g/lts)', value: 'densidadCorreccion', align: 'center' },
      { text: 'Valor calórico (kJ/kg)', value: 'valorCalorico', align: 'center' },
      { text: 'Existencia (lts)', value: 'existencia', align: 'center' },
      { text: 'Cobertura (hrs)', value: 'cobertura', align: 'center' },
      { text: 'Índice de consumo (lts)', value: 'indiceConsumo', align: 'center' },
      { text: 'Lubricante recibido (lts)', value: 'lubricteRecibido', align: 'center' },
      { text: 'Lubricante consumo reposición (lts)', value: 'lubricteCsmoReposicion', align: 'center' },
      { text: 'Lubricante consumo cambio (lts)', value: 'lubricteCsmoCambio', align: 'center' },
      { text: 'Lubricante consumo total (lts)', value: 'lubricteCsmoTotal', align: 'center' },
      { text: 'Lubricante existencia (lts)', value: 'lubricteExistencia', align: 'center' },
      { text: 'Lubricante cobertura (hrs)', value: 'lubricteCobertura', align: 'center' },
      { text: 'Lubricante índice consumo (lts)', value: 'lubricteIndiceCsmo', align: 'center' },
      { text: 'Refrigerante recibido (lts)', value: 'refrigteRecibido', align: 'center' },
      { text: 'Refrigerante consumo (lts)', value: 'refrigteConsumo', align: 'center' },
      { text: 'Refrigerante existencia (lts)', value: 'refrigteExistencia', align: 'center' },
