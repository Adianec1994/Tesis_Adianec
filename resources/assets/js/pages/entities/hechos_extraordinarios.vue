      ...
      <v-dialog v-model="dialog" max-width="500px">
        <template v-slot:activator="{ on }">
          <v-btn
            ...
            v-if="allowed('hecho_extraordinario','create')"
          >Nuevo</v-btn>
        </template>
        <v-card>
          <v-card-title>
    ...
    >
      <template v-slot:items="props">
        ...
        <td class="text-xs-center justify-center">
          <v-tooltip bottom v-if="allowed('hecho_extraordinario','update')">
            <v-icon
              small
          ...
          <v-tooltip bottom v-if="allowed('hecho_extraordinario','delete')">
            <v-icon
              small
              color="red lighten-2"
